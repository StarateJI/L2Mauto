...
_CONSOLE_WHITELIST = (
    ...
    # ── Обновления ──────────────────────────────────────────────────────
    "Доступна обнова",                # кнопка обновы
    "Установлена последняя версия",   # обнов нет
    "needs_update: local=",           # сравнение версий (одна строка)
    "Накатил обнпату",                # старт применения
    "Обнова бахнула",                 # ошибка применения
